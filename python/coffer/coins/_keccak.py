#https://raw.githubusercontent.com/ctz/keccak/master/keccak.py
...
if __name__ == '__main__':
    ...
    khash=Keccak256()
    tv="836b35a026743e823a90a0ee3b91bf615c6a757e2b60b9e1dc1826fd0dd16106f7bc1e8179f665015f43c6c81f39062fc2086ed849625c06e04697698b21855e"
    #tv="db308195813b2c644b33994a14cf1be0e3e7d2a0fa476f586ba7a56e19172273" #0xc5c33402cC57f517f27A5cfc13638d4139D25788
    tv=unhexlify(tv)
    khash.update(tv)
    hx=khash.hexdigest()
    addr=hx[-40:]
    ...
    a=checksum_encode(unhexlify(addr))
    print(a)
